  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        />
        <TouchableHighlight style={styles.takePhotoButton} onPress={this.captureImage}>
          <Text></Text>
        </TouchableHighlight>
      </View>
    );
